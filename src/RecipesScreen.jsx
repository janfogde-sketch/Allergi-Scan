...
export default function RecipesScreen({
  ...
  const renderRecipeDetail = () => {
    ...
    try {
      ...
      if (Array.isArray(parsed) && parsed[0]?.name) ingItems = parsed;
    } catch {}
    const allIngredientsAdded = ingItems ? ingItems.every((_,i) => listAdded[i]) : false;

    const ingredientRows = ingItems
      ? ingItems
      ...
      : <IngredientsList text={typeof r.ingredients_raw === 'string' ? r.ingredients_raw : JSON.stringify(r.ingredients_raw)} allergenFlags={rFlags} />;
    ...
    return (
      <div className="screen fade-in" style={{ paddingLeft:0, paddingRight:0, paddingBottom:110 }}>
        ...
        <div style={{ padding:"18px 16px 0" }}>
                ...
                {ingItems && addToList && (
                  <button
                    onClick={async () => {
                      ...
                      setListAdded(s => {
                        const next = { ...s };
                        ingItems.forEach((_, i) => { if (results[i]) next[i] = true; });
                        return next;
                      });
                    }}
                    style={{
          ...
          {steps.length > 0 && (
            <div style={UI.mb20}>
              <div style={UI.ufs13_fw800_cink_mb10}>Fremgangsmåde</div>
              <div style={UI.ubgsurface_bd1pxsolid_br12_ovhidden}>
                {steps.map((step, i) => {
      ...
      <div className="screen fade-in">
              ...
              return (
                <div key={p.id}
                  ...
                  <div style={{
                    ...
                    color: isActive ? "var(--on-green)" : "var(--muted)", display:"flex", alignItems:"center",
        ...
        {!recipesLoading && recipes.length === 0 && (
          <div>
            ...
            <div style={UI.ufs12_fw700_cmuted_ttuppercas_ls1px_mb10}>Hop direkte til</div>
      ...
      <div className="screen fade-in">
        ...
        <div style={UI.mb20}>
          ...
          <label style={{ display:"block", cursor:"pointer" }}>
            <input type="file" accept="image/*" onChange={handleImg} style={UI.udnone} />
            <div style={{
        ...
        <div style={UI.mb20}>
          ...
          <div style={UI.grid2gap8}>
            <div style={UI.udflex_aicenter_g6_p8px12px_bgsurface_bd1pxsolid_br10}>
              <span style={UI.ufs12_cmuted_shr0}>⏱ Forb.</span>
        ...
        <div style={UI.mb20}>
          ...
          <button onClick={() => setSubmitIngredients([...submitIngredients, {name:"",amount:"",unit:""}])}
            style={UI.uw100_p9px_br10_bd1pxdashe_bgnone_cmuted_fff_fs13_curpointer}>
            ＋ Tilføj ingrediens
          </button>
        </div>
        ...
        <div style={UI.mb20}>
          ...
          {/* Diæter */}
          <div style={UI.ufs12_cink3_mb8}>Passer opskriften til:</div>
  ...
  return (
    <>
        ...
        {screen === SCREENS.RECIPES && selectedRecipe && !showSubmitRecipe && renderRecipeDetail()}

        {/* ── OPSKRIFT LISTE ── */}
        {screen === SCREENS.RECIPES && !selectedRecipe && !showSubmitRecipe && renderRecipeList()}
        ...
        {screen === SCREENS.RECIPES && showSubmitRecipe && !submitSuccess && renderSubmitRecipeForm()}
