// @ts-nocheck
// ─────────────────────────────────────────────────────────────────────────────
// theme.jsx — EatSafe designsystem
//
...
// ── TEMA-TOKENS ──────────────────────────────────────────────────────────────
// Rediger disse for at skifte tema på tværs af hele appen.
...
export const THEME = {
  ...
  green:      "#22C55E",
  greenGlow:  "#4ADE80",
  greenLt:    "rgba(34,197,94,.1)",
  greenMid:   "rgba(34,197,94,.18)",

  // Fare — rød
  red:    "#E63946",
  redLt:  "rgba(230,57,70,.08)",
  redMd:  "rgba(230,57,70,.15)",

  // Advarsel — amber
  amber:   "#D97706",
  amberLt: "rgba(217,119,6,.08)",
  amberMd: "rgba(217,119,6,.14)",

  // Info — blå
  blue:   "#2563EB",
  blueLt: "rgba(37,99,235,.08)",
  ...
  // Skygger
  shadow:  "0 1px 3px rgba(31,39,51,.06),0 2px 8px rgba(31,39,51,.05)",
  shadow2: "0 4px 16px rgba(31,39,51,.12)",
  shadow3: "0 8px 32px rgba(31,39,51,.16)",
};

// ── CSS-STRENG ───────────────────────────────────────────────────────────────
// Genereret fra THEME-tokens. Injiceres i App.jsx via <style>{appCss}</style>
// Komponent-specifikke klasser er bevaret uændret herunder.
...
:root{
  ...
  --sh:0 1px 8px rgba(0,0,0,.25),0 2px 16px rgba(0,0,0,.2);
...
.stat-card{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px;box-shadow:var(--sh);}
...
.quick-btn{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:14px;display:flex;align-items:center;gap:10px;cursor:pointer;transition:all .15s;box-shadow:var(--sh);}
...
.product-card{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:13px;margin-bottom:8px;box-shadow:var(--sh);display:flex;align-items:center;gap:11px;}
...
/* ── LIST ── */
.list-item{display:flex;align-items:center;gap:11px;padding:11px 13px;background:var(--surface);border:1px solid var(--border);border-radius:11px;margin-bottom:7px;box-shadow:var(--sh);}
...
/* ── FAMILY ── */
.family-member{background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:13px 15px;margin-bottom:9px;box-shadow:var(--sh);}
...
/* ── UTILS ── */
.loader{display:flex;flex-direction:column;align-items:center;gap:10px;padding:28px;background:var(--surface);border-radius:12px;box-shadow:var(--sh);margin-bottom:10px;}
...
/* ── PRODUKT HERO ── */
.product-hero{background:var(--surface);border:1px solid var(--border);border-radius:var(--r);overflow:hidden;margin-bottom:10px;box-shadow:var(--sh);}
...
.mp-card{background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:18px 20px;margin-bottom:14px;box-shadow:var(--sh);}
...
.recipe-card{background:var(--surface);border:1px solid var(--border);border-radius:16px;overflow:hidden;box-shadow:var(--sh);cursor:pointer;transition:transform .15s,box-shadow .15s;position:relative;}
