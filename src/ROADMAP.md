...
| # | Opgave | Status | Noter |
|---|--------|--------|-------|
| 5.1 | App.jsx → useScanner.js (TRIN 1) | 🔲 | Udtræk ~20 scanner-states + lookupProduct (~100 linjer) + søge-useEffect (~30 linjer) + foto-scan logik fra App.jsx. App.jsx → ~1200 linjer. Sikreste første skridt — state flyttes til hook, App.jsx videregiver som props |
| 5.2 | ScannerScreen split (TRIN 2) | 🔲 | Udtræk NOTFOUND (indsend produkt) og SUGGEST_EDIT (ret produkt) til egne filer. ScannerScreen → ~1400 linjer. Afventer 5.1 |
