...
**24. sept. 2026 — Hjem-forsiden redesignet efter et delt referencedesign.**
...
**Visuel verifikation:** samme etablerede metode som beskrevet i afsnit 4
(håndskrevet mimic-HTML med ægte klasse-navne/CSS-værdier fra `theme.jsx`
+ `playwright-core` med den forudinstallerede Chromium-sti) — men iterativt
denne gang, ikke ét skud: seks screenshot-runder undervejs for at rette
rektangel-kanterne (se ovenfor), en overlap-bug (overskriften "Scan
produkt" lå delvist bag frugtbillederne ved første forsøg — rettet ved at
hæve `.hero-text`s top-padding), og et sidste layout-fix hvor blåbær-parret
delvist dækkede topbarens "Feedback"-knap.
